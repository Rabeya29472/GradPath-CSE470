...
const referralJobRoutes = require('./routes/referralJobRoutes');

const mockInterviewRoutes = require('./routes/mockInterviewRoutes');

const askAlumnusRoutes = require('./routes/askAlumnusRoutes');
...
app.get('/question-vault.html', (req, res) => {
    ...
    res.sendFile(
        path.join(
            __dirname,
            'public',
            'Company-Specific Question.html'
        )
    );
...
app.post('/api/verify-alumni', (req, res) => {
    ...
    try {
        ...
        const rawData =
            fs.readFileSync('./mockUniversityDB.json');

        const universityDatabase =
            JSON.parse(rawData);

        const recordFound =
            universityDatabase.find(
                student =>
                    student.studentId === studentId &&
                    student.gradYear === parseInt(gradYear)
            );
        ...
        if (recordFound) {
            ...
            return res.json({
                ...
                message:
                    "Match found! Status successfully updated to Verified Mentor."
            ...
            return res.status(404).json({
                ...
                message:
                    "Verification failed. No record found in university archives."
    ...
    (req, res) => {
        ...
        try {
            ...
            res.json({
                ...
                message:
                    "Resume request submitted successfully."
            ...
            res.status(500).json({
                ...
                message:
                    "Failed to submit resume request."
    ...
    (req, res) => {
        ...
        try {
            ...
            res.status(500).json({
                ...
                message:
                    "Failed to load resume requests."
        ...
        try {
            ...
            if (
                ...
                return res.status(400).json({
                    ...
                    message:
                        "Please add at least one assessment section."
            ...
            const totalScore =
                sections.reduce(
                    (sum, section) =>
                        sum + Number(section.score),
                    0
                );

            const overallScore =
                Math.round(
                    (totalScore / sections.length) * 10
                ) / 10;
...
// ================================
// Alumni Career Profile Directory APIs — MVC
// ================================
...
// ================================
// Exclusive Alumni Referral Job Board APIs — MVC
// ================================
...
// ================================
// Alumni Engagement Leaderboard API — MVC
// ================================
...
// ================================
// Student Mock-Interview Readiness Progress Tracker API — MVC
// ================================
...
// ================================
// Ask an Alumnus Discussion Forum APIs — MVC
// ================================

app.use(
    '/api/alumnus-questions',
    askAlumnusRoutes
);
