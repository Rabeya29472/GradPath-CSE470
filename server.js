...
const portfolioReviewController = require('./controllers/portfolioReviewController');
const dossierController = require('./controllers/dossierController');
const questionVaultController = require('./controllers/questionVaultController');
const mentorMatchmakerController = require('./controllers/mentorMatchmakerController');
...
// MVC booking API: the controller validates urgent requests and the model sorts the queue.
app.get('/api/bookings', bookingController.getBookings);
app.post('/api/book-slot', bookingController.createBooking);
app.get('/api/portfolio-reviews', portfolioReviewController.getReviews);
app.post('/api/portfolio-reviews', portfolioReviewController.createReview);
app.patch('/api/portfolio-reviews/:id', portfolioReviewController.updateReview);
app.get('/api/employability-dossier/:studentId', dossierController.getDossier);
app.get('/api/employability-dossier/:studentId/export', dossierController.exportDossier);
app.get('/api/question-vault', questionVaultController.getQuestions);
app.post('/api/question-vault', questionVaultController.createQuestion);
app.post('/api/question-vault/:id/helpful', questionVaultController.markHelpful);
app.get('/api/mentor-matchmaker', mentorMatchmakerController.getMentors);
app.post('/api/mentor-matchmaker/requests', mentorMatchmakerController.requestMentorship);
